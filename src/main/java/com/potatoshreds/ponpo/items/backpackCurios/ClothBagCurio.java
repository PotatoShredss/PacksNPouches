...
import static com.potatoshreds.ponpo.Config.clothBagStorage;
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundTag unused) {
        return CurioItemCapability.createProvider(new ICurio() {
            ...
            public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext sc, UUID uuid){
                ...
                CuriosApi.addModifier(stack, slots,"inventoryslots",null,clothBagStorage, AttributeModifier.Operation.ADDITION,"back");
