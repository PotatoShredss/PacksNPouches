...
import com.potatoshreds.ponpo.items.backpackCurios.*;
import com.potatoshreds.ponpo.items.pouchCurios.*;
...
public class PoNPoItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, ponpo.MODID);
