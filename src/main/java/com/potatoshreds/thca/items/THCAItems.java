...
public class THCAItems {
    ...
    public static final RegistryObject<Item> NINEMM = ITEMS.register("ninemm",
            () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> SEVENSIXTWO = ITEMS.register("sevensixtwo",
            () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> FIVEFIVESIX = ITEMS.register("fivefivesix",
            () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> TWELVEGAUGE = ITEMS.register("twelvegauge",
            () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> MUSKETBALL = ITEMS.register("musketball",
            () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> ACP = ITEMS.register("acp",
            () -> new Item(new Item.Properties()));
